...
def parser():
    ...
    parser.add_argument(
        ...
        required=True,
        type=str,
        help="Noiy file to denoise (.wav).")
    parser.add_argument(
        "--out_directory",
        required=False,
        type=str,
        default=".",
        help="Destination directory. Default to working directory.")
...
if __name__ == "__main__":
    ...
    produce_source_estimates(
        model_config=model_config,
        load_model='checkpoints/trained_model_from_github/model-10000',
        input_path=args.noisy_file,
